<h2 align="center">图聚合展示 by xhua</h2>

脚本适用于移动端和桌面 PC 端，本脚本可安装于支持 Tampermonkey 的浏览器，包括但不限于 Chrome，Kiwi，Edge 等。

- **简介**

  > [![github](https://img.shields.io/github/license/laraspy/xhua?color=blue&style=flat-square&logo=github)](https://github.com/LARASPY/xhua) [![Greasyfork](https://img.shields.io/static/v1?label=license&message=MIT&style=flat-square&labelColor=grey&color=blue&logo=data:image/png;base64,)](https://sleazyfork.org/zh-CN/scripts/442098-%E5%9B%BE%E8%81%9A%E5%90%88%E5%B1%95%E7%A4%BAby-xhua) [![Greasyfork](https://img.shields.io/static/v1?label=%20&message=GreasyFork&style=flat-square&labelColor=7B0000&color=960000&logo=data:image/png;base64,)](https://sleazyfork.org/zh-CN/scripts/442098-%E5%9B%BE%E8%81%9A%E5%90%88%E5%B1%95%E7%A4%BAby-xhua)
  >
  > **[脚本](https://sleazyfork.org/zh-CN/scripts/382266-%E5%9B%BE%E8%81%9A%E5%90%88%E5%B1%95%E7%A4%BAby-xhua)来自 selang 大佬**，但是该脚本年久失修。
  >
...
- **其他**
  ...
  > **Ⅳ.** 部分网站说明
  >
  > > ● 使用 `免费私房图` 、 `心动美图` 、 `elitebabes` ，前提是需要在 uBlock Origin `控制面板`*（浏览器右上角 uBlock Origin 扩展图标内的三个小齿轮）*中，添加 `静态规则` 来去除广告，不然该网站用不了。去广告规则如链接：[ublock 其他去广告规则](https://ghproxy.com/https://raw.githubusercontent.com/LARASPY/xhua/master/other/ublockRules.txt) 。
  > >
  > > _注：当然直接导入规则链接更方便。打开 uBlock Origin `控制面板`，点击 `规则列表 -> 导入 ` 复制上面的 去广告规则链接**地址** 进文本框，再点击应用更改。_
  > >
  > > ● <a href='https://www.nlegs.com/' target='_blank'><code>Nlegs</code></a> 请自行翻页，可能你还需要 <code>[如何绕过烦人的 hCaptcha & Cloudflare Captcha](https://blog.skk.moe/post/bypass-hcaptcha/)</code>
  > >
  > > ● `小黄书` 进行了聚合限制，想要取消限制。可以在 Tampermonkey 右上角，点击 `❌聚合已限制` 来取消。🆕
  >
  > **Ⅴ.** 关于手机浏览器选择，参考我之前的[评论](https://sleazyfork.org/zh-CN/scripts/442098-%E5%9B%BE%E8%81%9A%E5%90%88%E5%B1%95%E7%A4%BAby-xhua/discussions/142439)。
  >
  ...
  >     <pre>// @include      /https:\/\/mrcong.net/</pre>
  > </details>
  >
  > > `/域名网址/` 里面添加 `域名网址` 。域名网址 `https` 后面的 `//` 要写成 `\/\/` 。然后就是，还有一个地方要添加，如下面示例中的 `Mrcong` ，其 `hostnames` 要添加 `主机名` ，
  >
  > <details>
  >     <summary>展开 示例</summary>
  >     <pre>
...
- **脚本适配网址**
  ...
  > |      ✔ | <a href='https://www.xiuren01.xyz/' target='_blank'><code>秀人集</code></a>                                                                                                                                                                     |      ✔ | <a href='https://www.xrmnw.cc/' target='_blank'><code>秀人美女网</code></a>                                                                                                                                                                                                                                                      |
  ...
  > |     🍂 | <a href='https://ghproxy.com/https://raw.githubusercontent.com/LARASPY/xhua/master/other/ublockRules.txt' target='_blank'><code>Ublock 其他去广告规则</code></a> 🆕<br/>&emsp;&emsp;`更新时间:2023-3-29`                                        |     🍂 | <a href='https://ghproxy.com/https://raw.githubusercontent.com/LARASPY/xhua/master/other/autoPager/autoCustomRules.json' target='_blank'><code>AutoPage 无缝翻页规则</code></a> 🆕<br/>&emsp;&emsp;`更新时间:2023-3-29`                                                                                                          |
...
- **自动无缝翻页适配网址**
  ...
  > | `适配` | `< - - - - - - - - - - - - - - - 网站 - - - - - - - - - - - - - - ->`                           | `适配` | `< - - - - - - - - - - - - - - - 网站 - - - - - - - - - - - - - - ->`                 |
  > | -----: | ----------------------------------------------------------------------------------------------- | ------ | ------------------------------------------------------------------------------------- |
  > |      ✔ | <a href='https://hitxhot.com/' target='_blank'><code>Hit-x-Hot˙¹⁸⁺</code></a>                   | ✔      | <a href='https://www.yuleba.org/b/10-0.html' target='_blank'><code>娱乐吧</code></a>  |
  > |      ✔ | <a href='https://www.mnmulu.com/' target='_blank'><code>美女目录网</code></a>                   | ✔      | <a href='https://www.97mm.cc/' target='_blank'><code>撸女吧 ˙¹⁸⁺</code></a>           |
  > |      ✔ | <a href='https://www.nvsheng.cc/' target='_blank'><code>美图网</code></a>                       | ✔      | <a href='https://www.v2ph.com/' target='_blank'><code>微图坊</code></a>               |
  ...
  > |      ✔ | <a href='https://www.24cos.org/' target='_blank'><code>Cos 美女图</code></a>                    | ✔      | <a href='https://ahri8.top/' target='_blank'><code>松鼠症仓库</code></a>              |
...
- **其他网址**
    ...
    <details>
        ...
        <b>未适配网址: </b>
        <ul style="display: flex;flex-wrap: wrap;list-style-type:none;">
            <li style="margin: 5px;border-width: 2px;border-style: solid;border-color: transparent transparent black"><a href='http://chottie.com/blog/zh' target='_blank' style="text-decoration: none;"><code>Chottie</code></a></li>
            <li style="margin: 5px;border-width: 2px;border-style: solid;border-color: transparent transparent black"><a href='https://yande.re/' target='_blank' style="text-decoration: none;"><code>Y 站</code></a></li>
            <li style="margin: 5px;border-width: 2px;border-style: solid;border-color: transparent transparent black"><a href='https://konachan.com/' target='_blank' style="text-decoration: none;"><code>K 站</code></a></li>
            ...
            <li style="margin: 5px;border-width: 2px;border-style: solid;border-color: transparent transparent rgb(129, 92, 148);"><a href='https://bestgirlsexy.com/' target='_blank' style="text-decoration: none;"><code>BestGirlSexy</code></a></li>
        </ul>
        </pre>
    </details>
