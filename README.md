...
- **其他**
  ...
  >
  > **Ⅳ.** 使用 `免费私房图` 、 `心动美图` 、 `elitebabes` ，前提是需要在 uBlock Origin `控制面板`*（浏览器右上角 uBlock Origin 扩展图标内的三个小齿轮）*中，添加 `静态规则` 来去除广告，不然该网站用不了。去广告规则如链接：[ublock 其他去广告规则](https://ghproxy.com/https://raw.githubusercontent.com/LARASPY/xhua/master/other/ublockRules.txt) 。
  >
  ...
  > 祝你使用愉快！！！
  >
  > **Ⅸ.** `小黄书` 进行了聚合限制，想要取消限制。可以在 Tampermonkey 右上角，点击 `❌聚合已限制` 来取消。🆕
  >
  > ***
...
- **脚本适配网址**
  ...
  > |     🍂 | <a href='https://ghproxy.com/https://raw.githubusercontent.com/LARASPY/xhua/master/other/ublockRules.txt' target='_blank'><code>Ublock 其他去广告规则</code></a> 🆕<br/>&emsp;&emsp;`更新时间:2023-3-1`                                        |     🍂 | <a href='https://ghproxy.com/https://raw.githubusercontent.com/LARASPY/xhua/master/other/autoPager/autoCustomRules.json' target='_blank'><code>AutoPage 无缝翻页规则</code></a> 🆕<br/>&emsp;&emsp;`更新时间:2023-2-28`                                                                                                          |
