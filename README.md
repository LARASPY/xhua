...
- **其他**
  ...
  >
  > 6.关于手机版的网址链接跳转，如果使用本油猴脚本**可用网址**里面的网址，点击它会刷新本脚本网页，所以用起来不是很舒服。如果想点击链接就跳转到新网页，可以使用这个[`Markdown网站`](http://jbt.github.io/markdown-editor/)，Markdown 代码在[`LARASPY`](https://github.com/LARASPY/xhua)git 仓库里面，将仓库里面的[**`README.md`**](https://cdn.staticaly.com/gh/LARASPY/xhua@master/README.md)代码，复制到[`Markdown网站`](http://jbt.github.io/markdown-editor/)里面，然后点击保存按钮，就可以愉快的使用了，当然还可以点击顶部倒数第二个按钮(Reading Mode)，只查看 Markdown 页面，体验更佳。
  >
  > ***
